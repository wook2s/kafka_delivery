...
public class CompleteOutbox {
    ...
    public static CompleteOutbox createOutbox(Delivery delivery, String payload) {
        CompleteOutbox acceptOutbox = new CompleteOutbox();
